...
-- CREATE TABLE TODOS (Todos TEXT NOT NULL, todo_description TEXT, completed_todo INTEGER DEFAULT 0, id INTEGER PRIMARY KEY, chosen_date TEXT, user_id INTEGER, image_id INTEGER, FOREIGN KEY(user_id) REFERENCES Users(id), FOREIGN KEY(image_id) REFERENCES todoImages(id));
