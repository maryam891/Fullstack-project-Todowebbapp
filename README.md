...
The project originally used SQLite durin development and was later migrated in July 2026 to PostgreSQL. The old schema sql schema is kept as "old-sqlite.sql" to show the migration history.
